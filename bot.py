...
async def extract_price(text: str):
...
def get_post_category(text: str):
...
# Rules text constant
RULES_TEXT = """
🔰 Правила для #продам та #куплю:

📍 Формат оголошення:
• Вкажіть #продам або #куплю
• Коротко опишіть товар/послугу
• Обов'язково вкажіть ціну (ціна: XXXX грн)
• Для #футболка мінімальна ціна: 1500 грн
• Для інших товарів мінімальна ціна: 3000 грн

⏰ Обмеження:
• 1 оголошення кожного типу раз на 12 годин
• Заборонено дублювати оголошення

❌ Порушення ведуть до видалення повідомлення
